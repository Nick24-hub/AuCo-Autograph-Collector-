...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col2">
                <img alt="" src="<?php echo URLROOT; ?>/img/<?php echo $main_product->id; ?>_0.jpg" id="ProductImg">

                <div class="small-img-row">
                    <div class="small-img-col">
                        <img alt="" src="<?php echo URLROOT; ?>/img/<?php echo $main_product->id; ?>_0.jpg" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img alt="" src="<?php echo URLROOT; ?>/img/<?php echo $main_product->id; ?>_1.jpg" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img alt="" src="<?php echo URLROOT; ?>/img/<?php echo $main_product->id; ?>_2.jpg" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img alt="" src="<?php echo URLROOT; ?>/img/<?php echo $main_product->id; ?>_3.jpg" class="small-img">
                    </div>
                </div>
            </div>
            <div class="col2">
